...
# calculates maximum Fst and other statistics at the same site
...
#demography.add_population_parameters_change(time=2e+3, population="B", initial_size=(1e+4)*sim_b)
...
outfile = open("trunc_sitefst_rep_output_dros", "w")
