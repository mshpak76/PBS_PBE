...
setwd("/raid10/mshpak/Fst_Simulations/SlimScripts/Run_MSPrime/Run_MSPrime_CHTC/Sequence_Data/Background/Trunc_BGS")
bgs = read.csv("site_fst_bgs_output.csv", header=TRUE, sep='\t')
...
local_sweep = read.csv("Branch_Statistics_SiteFst_Small.csv",header=TRUE,sep='\t')
