# for comparison to Run_MSPrime_SingleRep_Dros.py, this rescales by reducing population size and split times by 50x while increasing mutation and recombination/conversation rates 100x
...
demography.add_population_parameters_change(time=3e+3, population="B", initial_size=1e+4)
...
outfile2 = open("samp_seq_rep_output_dros", 'w')
