...
# migration between population so that Nm=1 for each source population
...
demography.add_population(name = "A", initial_size = 20000, initially_active=True)
demography.add_population(name = "B", initial_size = 10000, initially_active=True)
...
demography.add_population_parameters_change(time=1500, population="B", initial_size=5000)
