...
# initially_active=True argument in add_population - remove?
...
demography.set_symmetric_migration_rate(["A","B","C"],0.001)
#demography.set_migration_rate(source = "A", dest = "B", rate = 0.0001)
demography.add_population_parameters_change(time=1000, population="B", initial_size=5000)
...
outfile = open("mig_ms_rep_output", "w")
